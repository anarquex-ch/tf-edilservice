            ...
            <div className="flex-1 overflow-y-auto px-5 py-8 flex flex-col w-full">
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-3 w-full">
                  <a href="tel:+41764611599" className="flex items-center gap-4 p-4 bg-gray-50 active:bg-gray-100 rounded-2xl w-full">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-bold text-primary">+41 76 461 15 99</p>
                    </div>
                  </a>
